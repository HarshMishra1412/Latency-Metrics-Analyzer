...
from stats_log import find_latency_outliers,fetch_top_n_slowest_latencies
anomalies_latency, average_latency, median_latency, threshold_latency= find_latency_outliers(all_latency)
top_n=fetch_top_n_slowest_latencies(all_latency, 5)
