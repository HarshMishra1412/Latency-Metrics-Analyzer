...
from stats_log import detect_anomalies, n_slowest_latencies
anomalies_latency, average_latency, median_latency, threshold_latency= detect_anomalies(all_latency)
